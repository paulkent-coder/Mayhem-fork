...
SMODS.Voucher {
	...
	loc_txt = {
		...
		text = {
			...
			"{C:planet}leveled up{}"]]
			"{X:attention,C:white}X2{} {C:planet}Jovian Moon{} effect"
		}
	},
	pos = { x = 2, y = 1 },
	atlas = 'voucher',
	...
	unlocked = true,
	redeem = function(self, card)
		G.GAME.jovian_moon_effect = (G.GAME.jovian_moon_effect or 1) * 2
	end,
	unredeem = function(self, card)
		G.GAME.jovian_moon_effect = (G.GAME.jovian_moon_effect or 1) / 2
	end,
...
SMODS.Voucher {
	...
	loc_txt = {
		...
		text = {
			...
			"{C:planet}leveled up{}"]]
			"{C:planet}Jovian Moons{} also give",
			"{X:purple,C:white}X#1#{} {C:may_ethereal}Level{} Mult and {C:may_ethereal}Level{} Chips"
		}
	},
	pos = { x = 3, y = 1 },
	atlas = 'voucher',
	...
	redeem = function(self, card)
		G.GAME.jovian_moon_multiplier = (G.GAME.jovian_moon_multiplier or 1) * card.ability.extra.multiplier
	end,
	unredeem = function(self, card)
		G.GAME.jovian_moon_multiplier = (G.GAME.jovian_moon_multiplier or 1) / card.ability.extra.multiplier
	end,
